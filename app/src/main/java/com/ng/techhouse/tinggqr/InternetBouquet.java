...
public class InternetBouquet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_internet_bouquet);
    ...
    private void getInternetBouquet() {
        M.showLoadingDialog(InternetBouquet.this);
        AndroidNetworking.post(new EndPoint().getHttps()+new EndPoint().getLordaragorn()+new EndPoint().getSmartWalet()+new EndPoint().getDataOps()+"Phone=2348060&PlatformId=001&Type=3")
                    ...
                    public void onError(ANError ANError) {
                        ...
                        if (ANError.getErrorCode() != 0) {
                            ...
                            if (ANError.getErrorCode() == 404) {
                                M.showToastL(InternetBouquet.this, getString(R.string.requested_resource_notfound));
                            } else if (ANError.getErrorCode() == 500) {
                                M.showToastL(InternetBouquet.this, getString(R.string.error_at_server));
                            }
                        } else {
                            M.showToastL(InternetBouquet.this, ANError.getErrorDetail());
                        }
    ...
    private void handleResponse(String response) throws JSONException {
        ...
        list = (ListView) findViewById(R.id.internetbouquet_list_view);
