...
public class CardAdapterPay1 extends ArrayAdapter<CardPojo> {
    ...
    public CardAdapterPay1(Activity context, ArrayList<CardPojo> cp) {
        ...
        rbcard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // selectedRadioButton = new ArrayList<CardPojo>();
                ...
                if(cp.get(position).getExtraData().equalsIgnoreCase("New Card Number")){
                FundWalletOption.cardLayout.setVisibility(View.VISIBLE);
                FundWalletOption.clearForm(FundWalletOption.cardLayout);

                } else{
                    FundWalletOption.cardLayout.setVisibility(View.GONE);
                }
