...
public class CardAdapterAirtime extends ArrayAdapter<CardPojo> {
    ...
    public CardAdapterAirtime(Activity context, ArrayList<CardPojo> cp) {
        ...
        rbcard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(cp.get(position).getId().toString().equals("080")){
                    AirtimePaymentOption.payBtn.setText("Proceed");
                }else{
                    AirtimePaymentOption.payBtn.setText("Proceed");
                }
