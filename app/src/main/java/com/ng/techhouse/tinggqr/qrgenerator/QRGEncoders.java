package com.ng.techhouse.tinggqr.qrgenerator;
...
public class QRGEncoders {

    private static final int WHITE = 0xFFFFFFFF;
   // private static final int BLACK = 0xFF000000;
   private static final int BLACK = 0xffff0000;
    ...
    public QRGEncoders(String data, Bundle bundle, String type, int dimension) {
    ...
    public Bitmap encodeAsBitmap(int indicator ) throws WriterException {
        ...
        for (int y = 0; y < height; y++) {
            ...
            for (int x = 0; x < width; x++) {
                pixels[offset + x] = result.get(x, y) ? indicator : WHITE;
            }
        }
